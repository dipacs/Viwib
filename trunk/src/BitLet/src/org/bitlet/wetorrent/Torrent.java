...
public class Torrent extends InterruptableTasksThread {
    ...
    public PieceChooser getPieceChooser() {
        return pieceChooser;
    }
    ...
    public synchronized void addEvent(Event event) {
        System.out.println(event.getDescription() + ": " + event.getAuthor());
...
//        }
    ...
    public long getPrefStart() {
        return prefStart;
    }

    public void setPrefStart(long prefStart) {
        this.prefStart = prefStart;
    }

    public long getPrefEnd() {
        return prefEnd;
    }

    public void setPrefEnd(long prefEnd) {
